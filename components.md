...
>
> **Bundled into Next.js:** **NOT YET** — the next Next.js canary React vendor bump will pick this up (expected in canary.92 or canary.93). If you want the ViewTransition fix on `next@canary` now, install `react@19.3.0-canary-83840902-20260719` + `react-dom@19.3.0-canary-83840902-20260719` explicitly; the vendor React inside `next@canary@91` is still `172742b4-20260716`. Verify with `npm view next@canary dependencies.react` — currently points at `19.3.0-canary-172742b4-20260716` (the vendored copy, not a peerDependency).
